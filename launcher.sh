...
# Sets Qt environment variables before Python/PySide6 loads
...
# Set Qt plugin paths BEFORE loading PySide6
export QT_PLUGIN_PATH="$FRAMEWORKS_DIR/PySide6/Qt/plugins"
export QT_QPA_PLATFORM_PLUGIN_PATH="$FRAMEWORKS_DIR/PySide6/Qt/plugins/platforms"

# Alternative locations (py2app)
if [ ! -d "$QT_PLUGIN_PATH" ]; then
    export QT_PLUGIN_PATH="$RESOURCES_DIR/PySide6/Qt/plugins"
    export QT_QPA_PLATFORM_PLUGIN_PATH="$RESOURCES_DIR/PySide6/Qt/plugins/platforms"
fi
